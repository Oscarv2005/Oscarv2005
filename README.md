...
> ⚙️ **To activate YOUR snake:** In your `Oscarv2005` repo go to **Actions tab → New workflow** and paste the yml below, then click **Run workflow**.
>
> ```yaml
> name: Generate Snake
> on:
